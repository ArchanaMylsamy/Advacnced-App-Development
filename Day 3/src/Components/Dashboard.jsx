...
const YogalaxComponent = () => {
  ...
  return (
    ...
    <Link to="/schedule"> <li className="link"><a href="#">Schedule</a></li></Link>
          <li className="link"><a href="#stories">Contact Us</a></li>
         
          <br></br>
        <Link to="/login">  <li className="link2"><a href="#contact">Login</a></li></Link>
        </ul>
      </nav>
      <header id="home">
        <div className="section__container header__container">
          <div className="header__content">
            ...
            <Link to="/signup"><button className="btn">Join Us</button></Link>
          </div>
    ...
    <section className="section__container photos__container">
      ...
      <footer className="footer" id="contact">
        <div className="section__container footer__container">
         ...
         {/* <p className='connect'>                                               +91234567 sattvaconnect@gmail.com</p> */}
        </div>
